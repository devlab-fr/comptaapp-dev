/*
  # Fix reference to journals table in auto_create_revenue_accounting_entry_impl

  ## Problem
  The function auto_create_revenue_accounting_entry_impl references the non-existent
  table "accounting_journals" in two places (immediate branch and deferred branch).
  The correct table name is "journals", causing error 42P01 every time a facture
  is marked as "payee".

  ## Fix
  Replace all occurrences of "accounting_journals" with "journals" in the function body.
*/

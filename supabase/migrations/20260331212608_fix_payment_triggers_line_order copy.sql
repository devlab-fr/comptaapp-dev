/*
  # Fix line_number → line_order dans les triggers de paiement

  1. Problème
    - Les fonctions utilisent line_number mais la colonne s'appelle line_order
    - Cause une erreur lors de l'insertion des lignes comptables

  2. Solution
    - Remplacer line_number par line_order dans les deux fonctions
*/

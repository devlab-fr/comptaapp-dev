/*
  # Module de Facturation (Ventes uniquement)
  ...
  1. Nouvelles Tables
    - `clients`
      ...
      - `nom` (text, pour particuliers)
      - `raison_sociale` (text, pour entreprises)
      - `adresse` (text)
      - `pays` (text)
      - `email` (text, nullable)
      - `siren` (text, nullable, pour entreprises)
      - `tva_intracommunautaire` (text, nullable, pour entreprises)
    ...
    - `factures`
      ...
      - `numero_facture` (text, unique per company)
      - `date_facture` (date)
      - `statut_paiement` (text: 'non_payee' ou 'payee')
      - `date_paiement` (date, nullable)
      - `montant_total_ht` (numeric)
      - `montant_total_tva` (numeric)
    ...
    - `lignes_factures`
      - `id` (uuid, primary key)
      - `facture_id` (uuid, foreign key to factures)
      - `description` (text)
      - `quantite` (numeric)

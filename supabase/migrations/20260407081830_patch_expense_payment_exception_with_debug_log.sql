/*
  # Patch temporaire de diagnostic — Log SQL persistant dans exception

  1. Modifications
    - Remplace UNIQUEMENT le bloc EXCEPTION final de auto_create_expense_payment_entry()
    - Enregistre SQLSTATE et SQLERRM dans expense_payment_trigger_debug
    - Retourne NEW pour ne pas bloquer le trigger
    - Aucune autre ligne de la fonction n'est modifiée

  2. Notes
    - PATCH TEMPORAIRE DE DIAGNOSTIC UNIQUEMENT
    - Ne modifie pas la logique métier
    - Ne modifie pas les INSERT/UPDATE existants
*/

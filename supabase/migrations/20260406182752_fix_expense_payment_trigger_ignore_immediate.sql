/*
  # Modifier le trigger de paiement pour ignorer les dépenses immédiates

  1. Objectif
    - Les dépenses en mode "immediate" ne doivent JAMAIS générer d'écriture de paiement
    - L'écriture d'achat (6xx/TVA/512) sert déjà de paiement
  ...
  2. Logique modifiée
    ...
    - Sinon : comportement actuel (créer écriture 401→512)

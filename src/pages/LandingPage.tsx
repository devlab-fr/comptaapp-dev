      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-white border-t border-b border-gray-100">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className={`flex flex-col items-center transition-all duration-600 ease-out hover:scale-[1.03] hover:shadow-lg rounded-lg p-4 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`} style={{ transitionDelay: '0ms' }}>
            ...
            <div className={`flex flex-col items-center transition-all duration-600 ease-out hover:scale-[1.03] hover:shadow-lg rounded-lg p-4 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`} style={{ transitionDelay: '100ms' }}>
              <div className="w-12 h-12 mb-3 flex items-center justify-center">
                <svg className="w-10 h-10 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={`flex flex-col items-center transition-all duration-600 ease-out hover:scale-[1.03] hover:shadow-lg rounded-lg p-4 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`} style={{ transitionDelay: '200ms' }}>
              <div className="w-12 h-12 mb-3 flex items-center justify-center">
                <svg className="w-10 h-10 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
